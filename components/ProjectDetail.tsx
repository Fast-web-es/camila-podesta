      ...
      <div className="flex flex-col lg:flex-row lg:gap-24">
        ...
        <div className="lg:w-1/3 mb-12 lg:mb-0">
          <div className="lg:sticky lg:top-32">
            <Link href={backLink} className="inline-block mb-8 text-[10px] uppercase tracking-widest text-gray-400 hover:text-ink transition-colors">
              &larr; {backLabel}
            </Link>
        ...
        <div className="lg:w-2/3 flex flex-col space-y-12 md:space-y-24">
          ...
          <div className="border-t border-gray-300 pt-16 mt-16 flex flex-col space-y-8 md:space-y-0 md:flex-row justify-between items-start md:items-center">
            {prevProject ? (
              <Link href={`${baseCategoryUrl}/${prevProject.id}`} className="group w-full md:w-auto">
            ...
            {nextProject ? (
              <Link href={`${baseCategoryUrl}/${nextProject.id}`} className="group w-full md:w-auto text-left md:text-right">
